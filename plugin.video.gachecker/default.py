...
#http://suq2ids38j823htmikc64nuc38f34h18q0kedd8.gcdn.biz/d/p/BKdtx4zKAgt6Ynzi56S5cSEUE_xGruZDxuJ9l8opOhvvs8cCdCK0vx4yRCjQKOa1/Extras%2FSeason%2003%2FStargate%20SG-1%20Season%2003%20Extra%2001%20-%20Season%203%20-%20Trailer.avi		
def test_dl_speed():
    dialog = xbmcgui.Dialog()
    dp = xbmcgui.DialogProgress()
    ...
    try:
        urllib.urlretrieve(url_19, path, lambda nb, bs, fs: _pbhook(nb, bs, fs, dp, start_time))
    except:
...
def main_menu():
    ...
    items.append(create_directory_tuple('Test Download Speed', 'test download'))#def test_dl_speed()
    return items
