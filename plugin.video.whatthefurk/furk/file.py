...
class File(object):
    ...
    def __init__(self, data):
        ...
        #is_protected - '1' if file protected. '0' if file isn't protected.
        try:
            self.is_protected = data['is_protected']  
        except:
            self.is_protected = None

        #is_linked - '1' if file linked to my file. '0' if file isn't linked.
        try:
            self.is_linked = data['is_linked']  
        except:
            self.is_linked = None			
        ...
        #files_num_video number of t_files with specific content type
        try:
            self.files_num_video = data['files_num_video']
        except:
            self.files_num_video = None
